...
public class ConnectDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ConnectGlobalFeatureConfigurator.Configure();
        ConnectModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ConnectDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ConnectResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Connect");

            options.DefaultResourceType = typeof(ConnectResource);
        ...
        {
            options.MapCodeNamespace("Connect", typeof(ConnectResource));
        });
    }
}
